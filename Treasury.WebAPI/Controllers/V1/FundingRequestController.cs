...
public class FundingRequestController : ControllerBase
{
    ...
    {
        var dto = _accessor.GetFundingRequests(request, out var maxResults);
    ...
    {
        var dto = _accessor.GetFundingRequestById(id);
    ...
    {
        var dto = _accessor.GetFundingRequestsByOrganization(name);
