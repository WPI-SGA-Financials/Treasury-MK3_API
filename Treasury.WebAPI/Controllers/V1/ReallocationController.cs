...
public class ReallocationController : ControllerBase
{
    ...
    {
        var dto = _accessor.GetReallocationRequests(request, out var maxResults);
    ...
    {
        var dto = _accessor.GetReallocationRequestById(id);
    ...
    {
        var dto = _accessor.GetReallocationRequestsByOrganization(name);
