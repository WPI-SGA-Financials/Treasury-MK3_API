...
public partial class sgadbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CategoriesTotalBudget>(entity =>
        {
            ...
            entity.HasComment(
                "View 'sgadb.Categories Total Budget' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them");
        });
        ...
        modelBuilder.Entity<TotalBudget>(entity =>
        {
            ...
            entity.HasComment(
                "View 'sgadb.Total Budget' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them");
        });
